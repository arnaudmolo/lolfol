...
export function glitchImageData ( image_data, parameters, callback ) {
  if (
    ...
    // 1. convert glitched byteArray to base64 URL.
    // 2. set base64 URL as src of an image
    // 3. put image on canvas and get imageData of canvas
    // 4. call callback, pass imageData as argument
    img = new Image();
    img.onload = function() {
      callback(img);
    };
...
// export function glitchImageData(imageData, parameters, callback) {
